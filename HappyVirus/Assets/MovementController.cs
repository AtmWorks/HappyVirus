...
public class MovementController : MonoBehaviour
{
    ...
    //[Header("Cambio de control / C�mara")]
    ...
    {
        // Determinar sprint seg�n esquema de control
        switch (PlayerStatics.controlType)
        {
            case PlayerStatics.ControlScheme.Mobile:
                // Tu flujo original: bot�n de sprint en pantalla
        ...
        // Penalizaci�n de movimiento durante acciones (disparo/crear huevo)
    ...
    //        outOfControl = true;
    //        mainCamera.target = virusDoble.transform;      // cambiar la c�mara
    //    }
    //    else
    //    {
    //        rig = GetComponent<Rigidbody2D>();
    //        VirusAttraction.isOnControl = false;           // para que el clon no te siga
    //        mainCamera.target = this.gameObject.transform; // cambiar la c�mara
    //        outOfControl = false;
    //    }
    //}
}
