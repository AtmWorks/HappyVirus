...
public class spikerEnemyBehaviour : MonoBehaviour
{
    ...
    public void pullBackMovement()
    {
        ...
        // Aplicar una interpolaci�n suave de la velocidad actual hacia la velocidad objetivo
    ...
    {
        // Obtenemos el �ngulo de rotaci�n actual en el eje Z
        float anguloActual = transform.rotation.eulerAngles.z;
        // Si la rotaci�n actual es diferente de la rotaci�n inicial en el eje Z
        if (anguloActual != rotacionInicial.eulerAngles.z)
        {
            // Calculamos el �ngulo de rotaci�n necesario para volver a la rotaci�n inicial
            float anguloObjetivo = rotacionInicial.eulerAngles.z;

            // Calculamos la direcci�n de rotaci�n m�s corta (en sentido horario o antihorario)
            ...
            // Aplicamos una fuerza para rotar el objeto en la direcci�n correcta
