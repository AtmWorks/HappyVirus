...
//    public float accelerationRate = 2f; // Velocidad de aceleraci�n
...
//    private void Update()
//    {
//        // Determinar la direcci�n hacia el punto objetivo
...
//        // Calcular la velocidad actual seg�n el tipo de movimiento seleccionado
//        switch (movementType)
//        {
...
//        // Aplicar la velocidad al Rigidbody2D en la direcci�n calculada
...
//    {
//        // Movimiento sinusoidal: la velocidad var�a sinusoidalmente
...
public class PatrolMovement : MonoBehaviour
{
    ...
    private Vector2 targetPosition;
    private int currentPatrolIndex = 0;
    private int patrolDirection = 1; // Direcci�n del patrullaje (1 para adelante, -1 para atr�s)
    private float currentSpeed = 0f;
    ...
    private void Update()
    {
        ...
        if (isWaiting)
        {
            ...
            else
            {
                ...
                return; // Salir del m�todo sin aplicar la velocidad
            }
        }
    ...
    private void IncrementPatrolIndex()
    {
        // Determinar el siguiente �ndice de patrullaje
        if (reverseLoop && (currentPatrolIndex == 0 || currentPatrolIndex == patrolPoints.Count - 1))
        {
            // Invertir direcci�n al llegar al inicio o al final
            patrolDirection *= -1;
        }

        // Incrementar el �ndice de patrullaje
        currentPatrolIndex += patrolDirection;

        // Revisar los l�mites del �ndice de patrullaje
