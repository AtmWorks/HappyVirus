...
public class shooterBlueEnemyBehaviour : MonoBehaviour
{
    ...
    {
        // Instancia el objeto "proyectil" en la posici�n y rotaci�n de "firePoint"
    ...
    //            Vector3 localPosition = transform.localPosition; // Obtener la posici�n local actual
    //            localPosition.y = newY; // Actualizar solo el componente Y en el espacio local
    //            transform.localPosition = localPosition; // Asignar la nueva posici�n local
    //            yield return null;
    //        }
    //    }
    //    if (!isY) 
...
//    public float rangoObjetivo = 5f; // Rango al que el objeto se acercar�.
...
//        if (objetivo != null)
//        {
//            // Calculamos la direcci�n hacia el objeto Virus.
...
//            // Movemos el objeto en la direcci�n y el movimiento senoidal.
