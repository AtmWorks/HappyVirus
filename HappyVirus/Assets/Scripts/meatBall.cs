...
public class meatBall : MonoBehaviour
{
    ...
    private IEnumerator DashCoroutine()
    {
        ...
        ChaseSpeed = 20f; // Ajusta la velocidad del dash seg�n sea necesario
        Debug.Log("ENEMY DASHED");
        // Establecer la velocidad deseada

        // Esperar un tiempo determinado para el movimiento del dash
        float dashDuration = 0.2f; // Ajusta la duraci�n del dash seg�n sea necesario
        yield return new WaitForSeconds(dashDuration);

        // Despu�s de la duraci�n del dash, detener el movimiento
        ChaseSpeed=1f;
    }
